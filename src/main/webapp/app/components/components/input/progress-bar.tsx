...
export function ProgressBar({ modal, inputLimit, inputLength, isCharLimitExceeded }: ProgressBarProps): JSX.Element {
    ...
    <button className="group relative cursor-pointer outline-none" type="button">
      ...
      >
        <svg className="overflow-visible" width="100%" height="100%" viewBox={viewBox}>
          <circle className="stroke-light-border dark:stroke-dark-border" cx="50%" cy="50%" fill="none" strokeWidth="2" r={r} />
          <circle
