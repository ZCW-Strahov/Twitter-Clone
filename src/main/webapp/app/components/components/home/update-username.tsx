...
export function UpdateUsername(): JSX.Element {
  ...
  const handleChange = ({ target: { value } }: ChangeEvent<HTMLInputElement | HTMLTextAreaElement>): void => setInputValue(value);
  ...
  return (
    <>
      ...
      >
        ...
        >
          <InputField label="Username" inputId="username" inputValue={inputValue} errorMessage={errorMessage} handleChange={handleChange} />
        </UsernameModal>
      </Modal>
      <Button
