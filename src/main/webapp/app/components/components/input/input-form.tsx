      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex items-center gap-3">
          <TextArea
            ...
            value={inputValue}
            placeholder={reply || replyModal ? 'Echo your reply' : "What's happening?"}
          ...
          />
          {reply && !visited && (
            <Button className="cursor-pointer bg-main-accent px-4 py-1.5 font-bold text-white opacity-50" onClick={handleFocus}>
              Reply
            </Button>
          )}
        </div>
