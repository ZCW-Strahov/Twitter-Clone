...
export function StatsEmpty({ title, modal, imageData, description }: StatsEmptyProps): JSX.Element {
  return (
    <div className={cn('flex justify-center p-8', modal && 'mt-[52px]')}>
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center gap-6">
          {imageData && <NextImage width={336} height={168} src={imageData.src} alt={imageData.alt} />}
