...
export function ViewParentTweet({ parentId, viewTweetRef }: ViewParentTweetProps): JSX.Element | null {
  ...
  if (!data)
    return (
      <div className="px-4 pt-3 pb-2">
        ...
        >
          This Echo was deleted by the Echo author.{' '}
          <a
            className="custom-underline text-main-accent"
            href="https://help.echo.com/rules-and-policies/notices-on-echo"
            target="_blank"
            rel="noreferrer"
          >
            Learn more
