...
const TrendingLists: FunctionComponent = () => {
  return (
    <div className="flex-1 rounded-mini overflow-hidden flex flex-col items-start justify-start max-w-full text-left text-lgi text-text font-lato">
      ...
      {/* <TrendingSection subtitle="Trending in Delaware" tag="#DEMODAY" count="2,066 Tweets" /> */}
      {/* <TrendingSection
