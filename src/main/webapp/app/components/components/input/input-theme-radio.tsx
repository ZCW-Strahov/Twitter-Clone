...
export function InputThemeRadio({ type, label }: InputThemeRadioProps): JSX.Element {
  ...
  return (
    ...
    >
      <div className="hover-animation flex h-10 w-10 items-center justify-center rounded-full">
        ...
        >
          <HeroIcon className="h-full w-full p-0.5 opacity-0 transition-opacity duration-200" iconName="CheckIcon" />
        </i>
      </div>
      {label}
    </label>
