...
/**
 * REST controller for managing {@link com.strahov.twitterclone.domain.UserProfile}.
 */
@RestController
        ...
        Optional<UserProfile> result = userProfileRepository
            ...
            .map(existingUserProfile -> {
                if (userProfile.getFname() != null) {
                    existingUserProfile.setFname(userProfile.getFname());
                }
                if (userProfile.getLname() != null) {
                    existingUserProfile.setLname(userProfile.getLname());
                }
