...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tweet.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TWEET_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TWEET actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TWEET actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TWEET actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TWEET actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TWEET actions', async () => {
      const arg = 42666;
