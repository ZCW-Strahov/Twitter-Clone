...
import { getEntity, deleteEntity } from './hash-tag.reducer';
...
export const HashTagDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="twitterCloneApp.hashTag.delete.question">Are you sure you want to delete Hash Tag {hashTagEntity.id}?</ModalBody>
      <ModalFooter>
