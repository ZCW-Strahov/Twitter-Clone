    ...
    <>
      ...
      <section className={cn('h-full overflow-y-auto transition-opacity', loading && 'pointer-events-none opacity-50')}>
        <div className="group relative mt-[52px] h-36 xs:h-44 sm:h-48">
          <input className="hidden" type="file" accept="image/*" ref={coverInputFileRef} onChange={editImage('cover')} />
          {coverPhotoURL ? (
            <NextImage
              useSkeleton
          ...
          <div className="absolute left-1/2 top-1/2 flex -translate-y-1/2 -translate-x-1/2 gap-4">
            ...
            >
              <HeroIcon className="hover-animation h-6 w-6 text-dark-primary group-hover:text-white" iconName="CameraIcon" />
            ...
            {coverPhotoURL && (
              ...
              >
                <HeroIcon className="hover-animation h-6 w-6 text-dark-primary group-hover:text-white" iconName="XMarkIcon" />
        ...
        <div className="relative flex flex-col gap-6 px-4 py-3">
          <div className="mb-8 xs:mb-12 sm:mb-14">
            <input className="hidden" type="file" accept="image/*" ref={profileInputFileRef} onChange={editImage('profile')} />
            <div
