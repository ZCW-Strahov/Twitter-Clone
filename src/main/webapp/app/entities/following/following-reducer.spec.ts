...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './following.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FOLLOWING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FOLLOWING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FOLLOWING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FOLLOWING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FOLLOWING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FOLLOWING actions', async () => {
      const arg = 42666;
